...
public abstract class AbstractJdbcTest {
   ...
   public AbstractJdbcTest(String propertyFileName) {
      ...
      try {
         ...
         setDerbyProperties(jdbcProperties);
      } catch (Exception e) {
         throw new IllegalStateException("Unable to load " + propertyFileName + "!");
      }
   }

   private void setDerbyProperties(Properties jdbcProperties) throws SQLException {
      url = jdbcProperties.getProperty("jdbc.url");
      con = DriverManager.getConnection(url);
   }

   private void setMySqlProperties(Properties jdbcProperties) throws ClassNotFoundException, SQLException {
